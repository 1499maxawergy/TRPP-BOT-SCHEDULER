...
Обновление расписания происходит каждые 24 часа.<br />
...
* Использование указанной группы для вывода расписания на сегодня или другой день текущей недели.<br />
...
* **time** - для работы со временем.<br />
##Интернет ресурсы
URL:\
Telegram: [t.me/mxwy_ezzic_bot](https://t.me/mxwy_ezzic_bot) <br />
##Авторство
